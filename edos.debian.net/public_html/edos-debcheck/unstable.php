...
$distributions = array("unstable");
function myinclude($filename) {
	if (file_exists($filename)) {include($filename);}}
?>

<h1>Uninstallable Packages in Debian unstable (sid)</h1>
...
<p>
<b>Disclaimer:</b>
Transient cases of uninstallable packages are quite normal in the
<i>unstable</i> distribution. Please do not file bugs based on
